...
class Driver():
    def reset(self):
        """ Create machine reset"""
        self._set_status('OFF')
        self._set_frequency(9e9)

    def __init__(self, dll_path: str = 'c:\\Program Files\\SignalCore\\SC5520A\\api\\c\\scipci\\x64\\sc5520a_uhfs.dll',
                 logger=None,
                 **kwargs):
        """
        Using QCoDeS driver for the Signal Core SC5521A.
    ...
    def output_on(self) -> None:
        return self._set_status('on')

    def output_off(self) -> None:
        return self._set_status('off')
    ...
    def set_rf_mode(self, rf_mode: str) -> None:
        # 'sweep' or 'single_tone'
        return self._set_rf_mode(rf_mode)
