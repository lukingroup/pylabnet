...
class Nanopositioners():
    ...
    STEP_MODE = ctypes.c_uint32(int("0x03050087",16))
    PKEY_NUM_BUS = ctypes.c_uint32(int("0x020F0016",16))
    PKEY_NUM_CH = ctypes.c_uint(int('0x020F0017', 16))
    PKEY_NUM_BUS_CH = ctypes.c_uint(int('0x02030017', 16))
    PKEY_MOVE_MODE = ctypes.c_uint(int('0x03050087', 16))
    ...
    #     :param channel:
    #     :param mode: (int) 0 corresponds to step, anything else is scan
    #     :param freq:
    #     :param amp:
    #     """
