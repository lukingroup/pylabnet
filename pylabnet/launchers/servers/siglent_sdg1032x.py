from pylabnet.network.client_server.siglent_sdg1032x import Service, Client
from pylabnet.hardware.cw_mw.siglent.sdg_1032x import Driver
from pylabnet.utils.helper_methods import GenericServer, get_ip, load_device_config


def launch(**kwargs):

    config_dict = load_device_config('siglent_sdg1032x', kwargs['config'])
