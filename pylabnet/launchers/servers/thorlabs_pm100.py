...
from pylabnet.hardware.power_meter.thorlabs_pm100 import Driver
from pylabnet.network.core.generic_server import GenericServer
from pylabnet.network.client_server.thorlabs_pm100 import Service, Client
from pylabnet.utils.helper_methods import get_ip, hide_console, load_device_config


def launch(**kwargs):
    """ Connects to PM100 and instantiates server
    ...
    try:
        settings = load_device_config('thorlabs_pm100',
                                      kwargs['config'],
    ...
    # the correct resource string
        ...
        kwargs['logger'].error('Please check GPIB/USB address, could not connect')
