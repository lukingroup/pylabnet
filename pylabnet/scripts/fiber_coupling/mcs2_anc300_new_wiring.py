...
class Controller:
    ...
    def __init__(self, nanopos_client: smaract_mcs2.Client, attocube_client: attocube_anc300.Client, gui='positioner_control_new_wiring_v2', log_client=None, config=None, port=None):
