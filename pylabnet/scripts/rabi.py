...
class Rabi:
    ...
    def run(self, clear_data=False, re_raise_kb_intrpt=False):
        ...
        # Measurement is interrupted by user
            ...
            # If this measurement is a part of larger one,
            # KeyboardInterrupt should be re-raised
            # to stop above-lying layers as well
            if re_raise_kb_intrpt:
    ...
    def _make_iter(self):
        ...
        state_ar = np.divide(
            x1=cnt_ar[1::2],  # readout counts
            x2=cnt_ar[::2]    # normalization counts
        )
