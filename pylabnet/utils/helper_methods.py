...
def pyqtgraph_save(widget, size, filename=None, directory=None, date_dir=False):
    """ Saves pyqtgraph figure to png

    :param size: (tuple) (width, height) of image to save
    :param dir: (str) directory to save to
    :param filename: (str) name of file to save
    :param date_dir: (bool) whether or not to use date sub-directory
    """
    ...
    exporter.parameters()['width'], exporter.parameters()['height'] = size[0], size[1]
